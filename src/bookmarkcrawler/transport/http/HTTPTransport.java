package bookmarkcrawler.transport.http;

import bookmarkcrawler.model.FetchedDocument;
import bookmarkcrawler.transport.common.Transport;
import bookmarkcrawler.transport.common.TransportException;
...
public class HTTPTransport implements Transport {
    ...
    /* (non-Javadoc)
     * @see ch2.webcrawler.transport.common.Transport#init()
     */
    public void init() {
    ...
    /* (non-Javadoc)
     * @see ch2.webcrawler.transport.common.Transport#clear()
     */
    public void clear() {
        httpclient = null;
        initialState = null;
    ...
    /* (non-Javadoc)
     * @see ch2.webcrawler.transport.common.Transport#fetch(java.lang.String)
     */
