...
import bookmarkcrawler.utils.FileUtils;
    ...
    private Map<String, String> loadProperties(File f, String delimiter) {
        ...
        try {
            ...
            while( (line = reader.readLine()) != null ) {
                ...
                if(delimiterIndex == -1){
                    // LOG error - reporrting the line data
//                    throw new RuntimeException("Error while reading metadata from file: '" + f.getAbsolutePath() + "'");   
                    continue;
                }
